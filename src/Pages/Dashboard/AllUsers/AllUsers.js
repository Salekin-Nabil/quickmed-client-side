...
const AllUsers = () => {
  ...
  const {
    ...
    queryKey: ["users"],
    queryFn: async () => {
      const res = await fetch("https://quick-med.fly.dev/users", {
        method: "GET",
        headers: {
  ...
  const handleMakeAdmin = (email) => {
    fetch(`https://quick-med.fly.dev/users/admin/${email}`, {
      method: "PUT",
      headers: {
        authorization: `Bearer ${localStorage.getItem("accessToken")}`,
      },
  ...
  const handleDeleteUser = (email) => {
    fetch(`https://quick-med.fly.dev/users/${email}`, {
      method: "DELETE",
      headers: {
        authorization: `Bearer ${localStorage.getItem("accessToken")}`,
      },
    ...
    fetch(`https://quick-med.fly.dev/bookings/admin/${email}`, {
      method: "DELETE",
      headers: {
        authorization: `Bearer ${localStorage.getItem("accessToken")}`,
      },
